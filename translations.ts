...
export const UI_STRINGS: Record<Language, any> = {
  en: {
    ...
    auth: {
      ...
      quickDemoDesc: "One-click instant login with preset demo accounts:",
      studentDemo: "Student Account",
      adminDemo: "Admin Account",
      studentCreds: "student@aimindset.com / student123",
      adminCreds: "admin@aimindset.com / admin123",
      invalidCreds: "Invalid email or password. Please verify your credentials or use Quick Demo Login.",
      ...
      requestReceived: "Your request has been submitted. Our team will review and contact you via email soon.",
      backToLogin: "Back to Login",
      whyJoin: "Why do you want to join?",
      goalsPlaceholder: "Tell us your goals...",
      categories: {
        teachers: "Teachers",
        parents: "Parents",
        business: "Business"
    ...
    admin: {
      ...
      approveBtn: "Approve & Give Access",
      noRequests: "No pending requests found",
      fetchError: "Failed to fetch requests",
      authError404: "Admin authentication service not found (404). Please verify your PocketBase URL and ensure the Admin API is enabled.",
    ...
    pwa: {
      ...
      getApp: "Get the App",
      installTitle: "Install AI Academy",
      howToInstall: "How to Install",
      safariSteps: "Follow these steps in Safari",
      browserInstall: "Use your browser's install feature",
      deviceInstall: "Use this as an app on your device",
      stepShare: "Tap the Share icon at the bottom of Safari.",
      stepAddHome: "Select \"Add to Home Screen\" from the menu.",
      stepBrowserIcon: "Look for the install icon in your browser's address bar or menu to install the app.",
      gotIt: "Got it",
      experienceApp: "Experience as an App"
    },
    assistants: {
  ...
  my: {
    ...
    nav: {
      ...
      langSelector: "ဘာသာစကား ရွေးချယ်မှု",
      switchToEn: "အင်္ဂလိပ်ဘာသာသို့ ပြောင်းရန်",
      switchToMy: "မြန်မာဘာသာသို့ ပြောင်းရန်",
      backToHome: "ပင်မစာမျက်နှာသို့ ပြန်သွားရန်",
      openQuiz: "အရည်အချင်းစစ်ရန် ဖွင့်ပါ",
      userMenu: "အသုံးပြုသူ မီနူး",
      closeMenu: "မီနူးကို ပိတ်ပါ",
    ...
    auth: {
      ...
      quickDemo: "အမြန် စမ်းသပ်ဝင်ရောက်ရန် (Quick Demo)",
      quickDemoDesc: "သတ်မှတ်ထားသော အကောင့်များဖြင့် တစ်ချက်နှိပ်ရုံဖြင့် ချက်ချင်းဝင်ရောက်နိုင်ပါသည် -",
      studentDemo: "ကျောင်းသား အကောင့်",
      adminDemo: "အက်ဒမင် အကောင့်",
      studentCreds: "student@aimindset.com / student123",
      adminCreds: "admin@aimindset.com / admin123",
      invalidCreds: "အီးမေးလ် သို့မဟုတ် လျှို့ဝှက်နံပါတ် မှားယွင်းနေပါသည်။ ကျေးဇူးပြု၍ ပြန်လည်စစ်ဆေးပါ သို့မဟုတ် Quick Demo ကို အသုံးပြုပါ။",
      ...
      authHeadline: "Master AI. Master Your Future.",
      requestSubmitted: "တောင်းဆိုမှု အောင်မြင်ပါသည်",
      requestReceived: "သင်၏ဝင်ခွင့်တောင်းဆိုမှုကို လက်ခံရရှိပါပြီ။ ကျွန်ုပ်တို့အဖွဲ့မှ စစ်ဆေးပြီးနောက် အီးမေးလ်မှတစ်ဆင့် မကြာမီ ဆက်သွယ်ပေးပါမည်။",
      backToLogin: "အကောင့်ဝင်ရန် ပြန်သွားပါ",
      whyJoin: "ဘာကြောင့် တက်ရောက်ချင်တာလဲ",
      goalsPlaceholder: "သင်၏ ရည်ရွယ်ချက်ကို ဖော်ပြပေးပါ...",
      categories: {
    ...
    admin: {
      portalTitle: "Admin Portal",
      secureAccess: "လုံခြုံစိတ်ချရသော ဝင်ရောက်မှုသာ",
      adminEmail: "အက်ဒမင် အီးမေးလ်",
      password: "လျှို့ဝှက်နံပါတ်",
      loginBtn: "ဒက်ရှ်ဘုတ်သို့ ဝင်ရောက်ရန်",
      dashboardTitle: "အက်ဒမင် ဒက်ရှ်ဘုတ်",
      accessManagement: "ဝင်ရောက်ခွင့် စီမံခန့်ခွဲမှု",
      logout: "ထွက်ရန်",
      searchPlaceholder: "နာမည် သို့မဟုတ် အီးမေးလ်ဖြင့် ရှာဖွေရန်...",
      pendingRequests: "စောင့်ဆိုင်းနေသော တောင်းဆိုမှုများ",
      student: "ကျောင်းသား",
      reason: "တက်ရောက်လိုသည့် အကြောင်းရင်း",
      requestedAt: "တောင်းဆိုသည့် အချိန်",
      actions: "လုပ်ဆောင်ချက်များ",
      cancel: "ပယ်ဖျက်ရန်",
      confirmApprove: "အတည်ပြုရန်",
      approveBtn: "အတည်ပြုပြီး ဝင်ခွင့်ပေးရန်",
      noRequests: "စောင့်ဆိုင်းနေသော တောင်းဆိုမှုများ မရှိပါ",
      fetchError: "တောင်းဆိုမှုများကို ရယူ၍မရပါ",
      authError404: "အက်ဒမင် စစ်ဆေးမှု ဝန်ဆောင်မှုကို ရှာမတွေ့ပါ (404)။ PocketBase URL ကို စစ်ဆေးပြီး Admin API ဖွင့်ထားကြောင်း သေချာပါစေ။",
    ...
    pwa: {
      ...
      getApp: "အက်ပ်ကို ရယူပါ",
      installTitle: "AI Academy ကို ထည့်သွင်းပါ",
      howToInstall: "အက်ပ်ကို ထည့်သွင်းနည်း",
      safariSteps: "Safari တွင် အောက်ပါအတိုင်း လုပ်ဆောင်ပါ",
      browserInstall: "သင့် Browser ၏ Install ခလုတ်ကို အသုံးပြုပါ",
      deviceInstall: "သင့်ဖုန်းတွင် အက်ပ်အဖြစ် အသုံးပြုပါ",
      stepShare: "အောက်ခြေရှိ Share icon ကို နှိပ်ပါ။",
      stepAddHome: "\"Add to Home Screen\" ကို ရွေးချယ်ပါ။",
      stepBrowserIcon: "သင့် Browser ၏ Address bar ရှိ Install icon ကို နှိပ်ခြင်းဖြင့် အက်ပ်ကို ထည့်သွင်းနိုင်ပါသည်။",
      gotIt: "နားလည်ပါပြီ",
      experienceApp: "အက်ပ်အဖြစ် အသုံးပြုရန်"
    },
    assistants: {
