...
import { Rocket, Box, Image as ImageIcon, Zap, Activity, ShieldCheck, Info, Award, MessageSquare, Mic, Play, Terminal, ExternalLink, Table, CheckCircle2, ChevronRight, Share2, FileSpreadsheet, Eye, Github, Sparkles, Loader2 } from 'lucide-react';
